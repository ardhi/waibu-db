...
async function getRecord ({ model, req, reply, id, options = {}, transaction, noAutoFilter } = {}) {
  const { model: mdl, recId, filter, attachment, stats, mimeType, opts } = await prepCrud.call(this, { model, req, reply, id, options, args: ['model', 'id'], transaction, noAutoFilter })
  const me = this
