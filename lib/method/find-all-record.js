...
async function findAllRecord ({ model, req, reply, options = {}, noAutoFilter, transaction } = {}) {
  const { model: mdl, opts, filter, attachment, stats, mimeType } = await prepCrud.call(this, { model, req, reply, options, args: ['model'], noAutoFilter, transaction })
